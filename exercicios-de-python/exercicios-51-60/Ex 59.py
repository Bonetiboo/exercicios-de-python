# Ex.59 - Para o exercício anterior, crie mais 4 objetos, crie uma lista de objetos, depois utilize uma estrutura de repetição para mostrar um texto com o respectivo desconto e salário a receber para cada pessoa.
